...
//		C:\Users\pc\AppData\Local\Google\Chrome\Application\chrome.exe
		...
		try {
			...
			Logger.getLogger(DriverFactory.class.getName()).log(Level.SEVERE,
					null, ex);
		}
	...
	public static WebDriver getChromeDriver(String chromePath) {
//		C:\Users\pc\AppData\Local\Google\Chrome\Application\chrome.exe
		ChromeDriverService service = new ChromeDriverService.Builder()
	...
	public static WebDriver getFirefoxDriverTextOnlyWithProxy(String proxyIP,
			int proxyPort) {
		...
		fp.setPreference("browser.cache.disk.parent_directory",
				"E:\\Temp\\Firefox\\Debug");// 缓存文件保存机制
	...
	public static WebDriver getFirefoxDriverWithProxy(String proxyIP,
			int proxyPort) {
		// System.setProperty ( "webdriver.firefox.bin" ,
		// "e:\\Program Files (x86)\\Mozilla Firefox\\firefox.exe" );
		FirefoxProfile fp = new FirefoxProfile();
